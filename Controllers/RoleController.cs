...
{
    [Dou.Misc.Attr.MenuDef(Id = "Role", Name = "角色管理", MenuPath = "系統管理", Action = "Index", Index = 1, Func = Dou.Misc.Attr.FuncEnum.ALL, AllowAnonymous = false, Icon = "Images/system.png")]
