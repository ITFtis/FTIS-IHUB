...
<a HREF="../default.asp" OnMouseOver="window.status='回管理系統主畫面'; return true;" OnMouseOut="window.status='';"><font color="#ffffff">回管理系統主畫面</font></a>
</td>
</tr>
</table>
...
<table border="1" width="1000" align="center" cellpadding="5" cellspacing="0" class="12word">
  <tr align="center" height="33" bgcolor="#00cc99">
	...
	<td>　8.USB裝置使用申請　（ <a href = "/usbda/usbda_1.asp" target=_blank>連結</a> ）</td>
	<td>　</td>
	</tr>
	<tr>
	<td width="205">　本會資訊系統指引</td>
	<td>　9.【<a href = "資訊/__ITmessage.htm" target=_blank>本會資訊系統指引</a>】</td>
	<td>　109.10</td>
	</tr>
</table>
